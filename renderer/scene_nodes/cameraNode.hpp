...
public:
	...
	void setTarget(const std::shared_ptr<SceneNode>& target)
	{
		this->_target = target;
	}
	void clearTarget() { this->_target = nullptr; }
	[[nodiscard]] std::shared_ptr<SceneNode> getTarget() const
	{
		return this->_target;
	}

	[[nodiscard]] Mat4x4 getWorldViewProjection(
	...
	void setCameraOffset(const Vec4& camera_offset)
	{
		this->_camera_offset_vector = camera_offset;
	}
